...
p=df1.drop(['left_Company','time_spend_company','sales','Emp_Collaborative','Emp_Work_Status','GEO','Role','Department','Will_Relocate','Gender','promotion_last_5years','Emp_Competitive','Work_accident','salary','Emp_Position','Emp_Title', 'Emp_Identity','EMP_Sat_OnPrem'], axis=1)
...
gbr=GradientBoostingRegressor(n_estimators=91,max_depth=5, min_samples_split=5, random_state=32)
gbr.fit(p_train,q_train)
pickle.dump(gbr ,open('model1.pkl','wb'))